...
class CalculatorTest {
    ...
    void plusTest(double x, double y, int result) {
    ...
    void minusTest(double x, double y, int result) {
    ...
    void multiplyTest(double x, double y, int result) {
    ...
    void divideTest(double x, double y, int result) {
