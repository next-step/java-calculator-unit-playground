...
public class TestStringCalculator {
    ...
    class StringCalculatorFeatureTest {
        ...
        void testValidInputs(){
            ...
            //커스텀 구분자 사용
            assertEquals(10,sc.addAll("//;\n1;2;3;4"));
            assertEquals(6,sc.addAll("//;\n1;2;3"));
            assertEquals(3,sc.addAll("//;\n1;2"));
            assertEquals(1,sc.addAll("//;\n1"));
        ...
        void testRuntimeException() {
            //숫자 이외의 값
            assertThrows(RuntimeException.class, () -> sc.addAll("1,a,3"));
            assertThrows(RuntimeException.class, () -> sc.addAll("1:a:3"));
            assertThrows(RuntimeException.class, () -> sc.addAll("//^\n1^a^3"));

            //음수 입력 케이스
            assertThrows(RuntimeException.class, () -> sc.addAll("1,-2,3"));
            assertThrows(RuntimeException.class, () -> sc.addAll("1:-2:3"));
            assertThrows(RuntimeException.class, () -> sc.addAll("//^\n1^-2^3"));
